...
public class ApiTest {
    ...
    public void test_insert_select() throws IOException {
        ...
        // 执行查询：默认是一个集合参数
        Activity activity = new Activity();
        activity.setActivityId(100019L);
        activity.setActivityName("测试活动");
        activity.setActivityDesc("测试数据插入");
        activity.setCreator("xiaofuge");
        int res = sqlSession.insert("com.wt.mybatis.dao.IActivityDao.insert", activity);

        Object obj = sqlSession.selectOne("com.wt.mybatis.dao.IActivityDao.insert!selectKey");
