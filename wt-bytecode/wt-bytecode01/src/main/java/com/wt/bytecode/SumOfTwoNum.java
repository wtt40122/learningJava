...
/**
 * @author: wtt
 * @date: 2022/8/28 19:29
 * @description:
 */
public class SumOfTwoNum extends ClassLoader {
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputClazz(bytes);
        // 加载AsmHelloWorld
        Class<?> clazz = new SumOfTwoNum().defineClass("com.wt.bytecode.AsmSumOfTwo", bytes, 0, bytes.length);
        // 反射获取 main 方法
    ...
    private static byte[] generate() {
        ...
        classWriter.visit(Opcodes.V1_7, Opcodes.ACC_PUBLIC, "com/wt/bytecode/AsmSumOfTwo", null, "java/lang/Object", null);
        ...
        methodVisitor.visitTypeInsn(Opcodes.NEW, "com/wt/bytecode/AsmSumOfTwo");
        methodVisitor.visitInsn(Opcodes.DUP);
        methodVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, "com/wt/bytecode/AsmSumOfTwo", "<init>", "()V");
        methodVisitor.visitInsn(Opcodes.ICONST_1);
        methodVisitor.visitInsn(Opcodes.ICONST_2);
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "com/wt/bytecode/AsmSumOfTwo", "sum", "(II)I");
