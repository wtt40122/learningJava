...
import com.wt.netty16.domain.*;
import com.wt.netty16.util.CacheUtil;
import com.wt.netty16.util.FileUtil;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        switch (fileTransferProtocol.getTransferType()) {
            ...
            case 2:
                ...
                FileBurstInstruct fileBurstInstruct = FileUtil.writeFile("C://", fileBurstData);
