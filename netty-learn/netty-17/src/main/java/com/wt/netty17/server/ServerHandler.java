...
import com.wt.netty17.domain.ClientMsgProtocol;
import com.wt.netty17.util.ChannelHandlerUtil;
import com.wt.netty17.util.MsgUtil;
...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        logger.info("链接报告完毕");
        ChannelHandlerUtil.channelGroup.add(ctx.channel());
    }
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        ChannelHandlerUtil.channelGroup.remove(ctx.channel());
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof WebSocketFrame) {
            ...
            if (2 == clientMsgProtocol.getType()) {
                ...
                ChannelHandlerUtil.channelGroup.writeAndFlush(textWebSocketFrame);
            }
