...
import com.wt.spring.test15.bean.*;
import com.wt.spring.test15.common.MyBeanFactoryPostProcessor;
import com.wt.spring.test15.common.MyBeanPostProcessor;
import com.wt.spring.test15.event.CustomEvent;
...
//        beanDefinitionReader.loadBeanDefinitions("classpath:spring.xml");
    ...
    public void test_dynamic() {
        ...
        advisedSupported.setMethodMatcher(new AspectJExpressionPointCut("execution(* com.wt.spring.test15.bean.UserService.*(..))"));
