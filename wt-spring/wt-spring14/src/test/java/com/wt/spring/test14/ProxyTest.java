...
import com.wt.spring.test14.bean.BookService;
import com.wt.spring.test14.bean.IBookService;
import com.wt.spring.test14.bean.UserService;
...
public class ProxyTest {
    ...
    public void test_proxy() {
        ...
        IBookService bookService = (IBookService) Proxy.newProxyInstance(ClassUtils.getClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            MethodMatcher methodMatcher = new AspectJExpressionPointCut("execution(* com.wt.spring.test13.bean.IBookService.*(..))");
