...
import com.wt.spring.test16.bean.BookService;
import com.wt.spring.test16.bean.IBookService;
import com.wt.spring.test16.bean.UserService;
...
public class ProxyTest {
    ...
    public void test_proxy() {
        ...
        IBookService bookService = (IBookService) Proxy.newProxyInstance(ClassUtils.getClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            MethodMatcher methodMatcher = new AspectJExpressionPointCut("execution(* com.wt.spring.test16.bean.IBookService.*(..))");
